...
<head>
    ...
    <link
        href="<?php echo base_url()?>assets/admin_template/css/font.google.css"
        rel="stylesheet">
...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><?php echo $header?></h1>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Reservatio 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="<?php echo base_url()?>assets/admin_template/js/demo/chart-area-demo.js"></script>
    <script src="<?php echo base_url()?>assets/admin_template/js/demo/chart-pie-demo.js"></script>
